...
SCALES = (
 ...
 Scale(name='Major Blues', notes=[0, 2, 3, 4, 7, 9]),
 Scale(name='Minor Blues', notes=[0, 3, 5, 6, 7, 10]),
 Scale(name='Major+Blues', notes=[0, 2, 3, 4, 5, 7, 8, 9, 11]),
 Scale(name='Dorian+Blues', notes=[0, 2, 3, 5, 6, 7, 9, 10]),
 ...
 Scale(name='Turkey Anvar', notes=[0, 4, 5, 8, 9, 11]),
